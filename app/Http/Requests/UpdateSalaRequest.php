...
class UpdateSalaRequest extends FormRequest
{
    ...
    {
        $sala = $this->route('sala');
        return $this->user()->can('update', $sala);
    }
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:salas,name,' . $this->route('sala')->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'capacidade.min' => 'A capacidade da sala deve ser no mínimo 1.',
        ];
    }
}
